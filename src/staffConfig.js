...
export const STAFF = [
  { name: 'Brenton Lovering', email: 'brenton@technomed.com.au', firstName: 'Brent', division: 'Operations', role: 'Managing Director', isAdmin: true, hasTimesheets: false, mobileNumber: '' },
  ...
  { name: 'Ben Cassidy', email: 'ben@technomed.com.au', firstName: 'Ben', division: 'Spine', role: 'Clinical Support Specialist', isAdmin: false, hasTimesheets: true, mobileNumber: '' },
  { name: 'Matthew Usher', email: 'mat@technomed.com.au', firstName: 'Mat', division: 'CMF', role: 'Business Development and Director', isAdmin: false, hasTimesheets: true, mobileNumber: '' },
  ...
  { name: 'Aimee Vulinovich', email: 'aimee@technomed.com.au', firstName: 'Aimee', division: 'Spine', role: 'Clinical Support Specialist', isAdmin: false, hasTimesheets: true, mobileNumber: '' }
]
